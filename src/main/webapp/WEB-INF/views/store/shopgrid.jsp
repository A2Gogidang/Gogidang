<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/shopgrid.css" type="text/css">
<!DOCTYPE html>
<html lang="zxx">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9 col-md-7">
	                    ...
	                    <div class= "shoplist" >
		                    	...
		                    	<div class="shoplisttwo">
		                    		...
		                    		<div class="shoplisttwot">
			                    		...
			                    		<li><input type="checkbox" id="s_gyeong" class="f_check" name="f_Acheck" value="경기" >경기</li>
			                    		<li><input type="checkbox" id="s_gang" class="f_check" name="f_Acheck" value="강원" >강원</li>
			                    		<li><input type="checkbox" id="s_jeon" class="f_check" name="f_Acheck" value="전라" >전라</li>
			                    		<li><input type="checkbox" id="s_gyeong" class="f_check" name="f_Acheck" value="경상" >경상</li>
			                    		<li><input type="checkbox" id="s_chung" class="f_check" name="f_Acheck" value="충청" >충청</li>
		                    		</div>
	                    		</div>
	                    		...
	                    		<div class="shoplistb">
		                    		<div class="shoplistbu">
		                    			<div class="shoplist_but"><button type="submit" class="site-btn" name="button" >검색</button></div>
		                    		</div>
	                    		</div>
	                    </div>
                    </div>
                    ...
                    <div class="product__pagination_center">
