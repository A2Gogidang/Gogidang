				...
				<div class="product__details__text">
					...
					<ul style="margin-top: 60px;">
						<li><img src="resources/DetailStore/Icon/time.ico"
							width="40px" height="42px;" alt='' / style="margin-right: 10px;"><span>운영시간
								: &nbsp;&nbsp;<%=svo.getS_hour()%></span></li>
						<li><img src="resources/DetailStore/Icon/call.ico"
							width="40px" height="42px;" alt='' / style="margin-right: 10px;"><span>전화번호
					...
					<div class="product__details__tab__desc">
						...
						<div class="row featured__filter">
							<div class="col-lg-3 col-md-4 col-sm-6 mix oranges fresh-meat">
								<div class="featured__item">
									<div class="featured__item__pic set-bg"
										data-setbg="resources/img/featured/feature-1.jpg"></div>
							...
							<div class="col-lg-3 col-md-4 col-sm-6 mix vegetables fastfood">
								<div class="featured__item">
									<div class="featured__item__pic set-bg"
										data-setbg="resources/img/featured/feature-2.jpg"></div>
									<div class="featured__item__text">
										<h6>
											<a href="#">마싯어요!</a>
										</h6>
							...
							<div class="col-lg-3 col-md-4 col-sm-6 mix vegetables fresh-meat">
								<div class="featured__item">
									<div class="featured__item__pic set-bg"
										data-setbg="resources/img/featured/feature-3.jpg"></div>
									<div class="featured__item__text">
										<h6>
											<a href="#">짱!</a>
										</h6>
							...
							<div class="col-lg-3 col-md-4 col-sm-6 mix fastfood oranges">
								<div class="featured__item">
									<div class="featured__item__pic set-bg"
										data-setbg="resources/img/featured/feature-4.jpg"></div>
									<div class="featured__item__text">
										<h6>
											<a href="#">또올래요~</a>
										</h6>
