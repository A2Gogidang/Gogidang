    ...
    <!-- Hero Section End -->
		<center>
			<table border=1 width=400>
				...
				<tr>
					<td>주소 :</td>
					<td><input type="text" name="u_addr" value="<%=memberVO.getU_addr()%>"><%=memberVO.getU_addr()%></td>
				</tr>	
				<tr>
					<td>이메일 주소 :</td>
					<td><input type="text" name="u_email" value="<%=memberVO.getU_email()%>"><%=memberVO.getU_email()%></td>
				</tr>
				<tr>
					<td>핸드폰 번호 :</td>
					<td><input type="text" name="u_phone" value="<%=memberVO.getU_phone()%>"><%=memberVO.getU_phone()%></td>
				</tr>
				<tr align=center>
